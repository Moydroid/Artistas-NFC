    ...
    <main className="min-h-screen bg-black text-white p-8">
      ...
      <div className="space-y-6 max-w-4xl">
        <div className="bg-zinc-900 p-6 rounded-xl">
          ...
          <p className="text-zinc-400">URL: {supabaseUrl?.substring(0, 30)}...</p>
          <p className="text-zinc-400">Key: {supabaseKey?.substring(0, 20)}...</p>
        </div>
        
        <div className="bg-zinc-900 p-6 rounded-xl">
          <h2 className="text-xl font-bold mb-2 text-purple-400">Tabla artists:</h2>
          {artistsError ? (
        ...
        <div className="bg-zinc-900 p-6 rounded-xl">
          <h2 className="text-xl font-bold mb-2 text-purple-400">Tabla tracks:</h2>
          {tracksError ? (
