      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-zinc-900/50 p-6 rounded-2xl border border-zinc-800 backdrop-blur-sm">
          ...
          {tracks && tracks.length > 0 ? (
            tracks.map((track: any) => {
              ...
              return (
                <div key={track.id} className="mb-6 border-b border-zinc-800 pb-6 last:border-0 last:pb-0">
                  <p className="font-bold text-lg mb-3 text-white">{track.titulo || track.title || 'Sin titulo'}</p>
                  {audioSrc ? (
            ...
            <p className="text-zinc-500 text-center py-8">No hay canciones registradas para este artista aun.</p>
          )}
        </div>
      </div>
    </main>
